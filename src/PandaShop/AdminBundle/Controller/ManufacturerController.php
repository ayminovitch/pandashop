...
use PandaShop\ShopBundle\Entity\Manufacturer;
...
class ManufacturerController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('PandaShop\ShopBundle\Form\Type\ManufacturerType', $manufacturer);
    ...
    {
        $deleteForm = $this->createDeleteForm($manufacturer);
        $editForm = $this->createForm('PandaShop\ShopBundle\Form\Type\ManufacturerType', $manufacturer);
