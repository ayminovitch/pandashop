...
use PandaShop\ShopBundle\Entity\News;
...
class NewsController extends Controller
{
    ...
    {
        $news = new News();
        $form = $this->createForm('PandaShop\ShopBundle\Form\Type\NewsType', $news);
    ...
    {
        $deleteForm = $this->createDeleteForm($news);
        $editForm = $this->createForm('PandaShop\ShopBundle\Form\Type\NewsType', $news);
