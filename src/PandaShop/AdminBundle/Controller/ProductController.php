...
namespace PandaShop\AdminBundle\Controller;

use Doctrine\ORM\EntityManager;
use PandaShop\ShopBundle\Entity\Image;
...
use PandaShop\ShopBundle\Entity\Product;
...
class ProductController extends Controller
{
    ...
    {
        $product = new Product();
        $form = $this->createForm('PandaShop\ShopBundle\Form\Type\ProductType', $product);
    ...
    {
        $deleteForm = $this->createDeleteForm($product);
        $editForm = $this->createForm('PandaShop\ShopBundle\Form\Type\ProductType', $product);
