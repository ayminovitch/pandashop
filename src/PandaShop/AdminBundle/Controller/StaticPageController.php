...
use PandaShop\ShopBundle\Entity\StaticPage;
...
class StaticPageController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('PandaShop\ShopBundle\Form\Type\StaticPageType', $staticPage);
    ...
    {
        $deleteForm = $this->createDeleteForm($staticPage);
        $editForm = $this->createForm('PandaShop\ShopBundle\Form\Type\StaticPageType', $staticPage);
