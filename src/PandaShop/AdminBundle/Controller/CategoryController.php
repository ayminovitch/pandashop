...
use PandaShop\ShopBundle\Entity\Category;
...
class CategoryController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('PandaShop\ShopBundle\Form\Type\CategoryType', $category);
    ...
    {
        $deleteForm = $this->createDeleteForm($category);
        $editForm = $this->createForm('PandaShop\ShopBundle\Form\Type\CategoryType', $category);
