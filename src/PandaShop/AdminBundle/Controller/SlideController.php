...
use PandaShop\ShopBundle\Entity\Slide;
...
class SlideController extends Controller
{
    ...
    {
        $slide = new Slide();
        $form = $this->createForm('PandaShop\ShopBundle\Form\Type\SlideType', $slide);
    ...
    {
        $deleteForm = $this->createDeleteForm($slide);
        $editForm = $this->createForm('PandaShop\ShopBundle\Form\Type\SlideType', $slide);
