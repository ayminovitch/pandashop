...
use PandaShop\ShopBundle\Entity\Measure;
...
class MeasureController extends Controller
{
    ...
    {
        $measure = new Measure();
        $form = $this->createForm('PandaShop\ShopBundle\Form\Type\MeasureType', $measure);
    ...
    {
        $deleteForm = $this->createDeleteForm($measure);
        $editForm = $this->createForm('PandaShop\ShopBundle\Form\Type\MeasureType', $measure);
