...
namespace PandaShop\ShopBundle\Controller;

use PandaShop\ShopBundle\Entity\Product;
use PandaShop\ShopBundle\Entity\Orders;
use PandaShop\UserBundle\Entity\User;
...
class CartController extends Controller
{
    ...
    {
        $order = new Orders();
        $form = $this->createForm('PandaShop\ShopBundle\Form\Type\OrdersType', $order);
