 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="PandaShop\ShopBundle\Repository\OrdersRepository")
 */
class Orders
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="\PandaShop\UserBundle\Entity\User", inversedBy="orders")
     ...
     * Add orderProducts
     *
     * @param \PandaShop\ShopBundle\Entity\OrderProduct $orderProducts
     * @return Orders
     */
    public function addOrderProduct(\PandaShop\ShopBundle\Entity\OrderProduct $orderProducts)
    {
     ...
     * @param \PandaShop\ShopBundle\Entity\OrderProduct $orderProducts
     */
    public function removeOrderProduct(\PandaShop\ShopBundle\Entity\OrderProduct $orderProducts)
    {
